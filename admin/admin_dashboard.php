    ...
    <div class="container">
        <div class="card hero-card dashboard mb-4 fade-slide">
            <div class="card-body p-4 p-md-5">
                ...
                <p class="mb-0 opacity-75">Monitor, prioritize, and resolve complaints.</p>
            </div>
        </div>
            ...
            <div class="col-md-6 col-lg-4">
                <div class="card action-card h-100">
                    <div class="card-body p-4">
                        ...
                        <a href="view_complaints.php" class="btn btn-primary btn-sm">Open List</a>
                    </div>
                </div>
            </div>
            ...
            <div class="col-md-6 col-lg-4">
                <div class="card action-card h-100">
                    <div class="card-body p-4">
                        ...
                        <a href="view_complaints.php" class="btn btn-outline-secondary btn-sm">Manage Status</a>
                    </div>
                </div>
            </div>
            ...
            <div class="col-md-12 col-lg-4">
                <div class="card action-card h-100">
                    <div class="card-body p-4">
                        ...
                        <a href="../index.html" class="btn btn-outline-primary btn-sm">Open Home</a>
                    </div>
                </div>
            </div>
        </div>
